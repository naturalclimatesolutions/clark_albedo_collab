...
climsnowcover = strcat(dataroot,"ProcessedDatasets\SnowCover\");
...
resultsGlasgowCOP = strcat(resfolder,"Maps\DataAvailability\");
resultmaps = strcat(resfolder,"Maps\");
DataAvailabilityMatFile = strcat(intmat,"DataAvailability.mat");
